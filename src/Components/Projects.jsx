...
const Projects = () => {
    return (
        <>
            <div id='projects' className="relative bg-black min-h-[120px] text-white overflow-hidden">
                {[...Array(10)].map((_, i) => (
                    <div
                        key={i}
            ...
            <div className='flex flex-col bg-gradient-to-tr from-gray-950 via-gray-900 to-black pt-10 md:pt-20 w-full min-h-screen'>

                <div className='flex items-center justify-center w-full'>
                    <h3 className='text-3xl sm:text-4xl md:text-6xl font-extrabold bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-transparent bg-clip-text drop-shadow-lg tracking-wide'>
                        Projects
                    </h3>
                </div>

                <div className='outline-double outline-red-400 w-[98%] md:w-[94%] mx-auto my-6 md:my-10 rounded-xl bg-gray-800 p-4 md:p-12'>
                    <h5 className='text-white font-bold text-2xl md:text-3xl pb-4 md:pb-6 border-b border-red-400'>Web Projects</h5>

                    {/* Project Card 1 */}
                    <div className='flex flex-col md:flex-row items-start gap-4 md:gap-6 bg-gray-600 p-4 md:p-6 rounded-md transition-transform duration-300 hover:scale-100 scale-100 md:scale-90 mt-6 md:mt-10'>
                        <img
                            className='w-full md:w-1/3 rounded-lg shadow-lg object-cover max-h-64 md:max-h-[380px]'
                            src={findMyFamily}
                            alt="Find My Family App"
                        />
                        <div className='text-white md:w-2/3 space-y-4'>
                            <h4 className='font-bold text-xl md:text-2xl mb-2'>1. Find My Family App</h4>
                    ...
                    <div className='flex flex-col md:flex-row items-start gap-4 md:gap-6 bg-gray-600 p-4 md:p-6 rounded-md transition-transform duration-300 hover:scale-100 scale-100 md:scale-90 mt-6 md:mt-10'>
                        ...
                        />
                        <div className='text-white md:w-2/3 space-y-4'>
                            <h4 className='font-bold text-xl md:text-2xl mb-2'>2. RoyalNest Hotel Booking App(Group Project)</h4>
                            <p className='text-base md:text-lg leading-relaxed text-gray-300'>
                    ...
                    <div className='flex flex-col md:flex-row items-start gap-4 md:gap-6 bg-gray-600 p-4 md:p-6 rounded-md transition-transform duration-300 hover:scale-100 scale-100 md:scale-90 mt-6 md:mt-10'>
                        ...
                        />
                        <div className='text-white md:w-2/3 space-y-4'>
                            <h4 className='font-bold text-xl md:text-2xl mb-2'>3. FitFusion Web App(Group Project)</h4>
                            <p className='text-base md:text-lg leading-relaxed text-gray-300'>
                ...
                <div className='outline-double outline-yellow-400 w-[98%] md:w-[94%] mx-auto my-6 md:my-10 rounded-xl bg-gray-800 p-4 md:p-12'>
                    <h5 className='text-white font-bold text-2xl md:text-3xl pb-4 md:pb-6 border-b border-yellow-400'>Miscellaneous Web Projects</h5>
                ...
                <div className='outline-double outline-green-400 w-[98%] md:w-[94%] mx-auto my-6 md:my-10 rounded-xl bg-gray-800 p-4 md:p-12'>
                    <h5 className='text-white font-bold text-2xl md:text-3xl pb-4 md:pb-6 border-b border-red-400'>System-Level Projects</h5>
                    <div className='flex flex-col md:flex-row items-start gap-4 md:gap-6 bg-gray-600 p-4 md:p-6 rounded-md transition-transform duration-300 hover:scale-100 scale-100 md:scale-90 mt-6 md:mt-10'>
                        <div className='text-white md:w-2/3 space-y-4'>
